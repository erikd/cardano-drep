...
This file will remain static for as long as possible because it is hashed and the hash is stored
on the Cardano blockchain. The other files in this Github repo, will contain notes about Cardano
in general, the DRep process, discussion on upcoming governance questions and a record of my
previous voting.
